...
namespace RegawMOD.Android
{
    ...
    public class BuildProp
    {
        ...
        /// <summary>
        /// Retruns the string value of a property for the device
        /// 
        /// for a nice list i added a few prop names here 
        /// 
        /// http://www.github.com/
        /// </summary>
        /// <param name="propname">property name </param>
        /// <returns>string value</returns>
        public string GetPropDetials(string propname)
        {
            string rtnstring = string.Empty;
            AdbCommand adbCdm = Adb.FormAdbShellCommand(this.device, false, "getprop", propname);
            try
            {
                rtnstring = Adb.ExecuteAdbCommandReturnExitString(adbCdm);
